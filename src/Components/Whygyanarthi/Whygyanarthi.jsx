                ...
                <div className="mx-auto container">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div >
                            ...
                            <p className='urbanpara'>Equipped with the best facilities, the campus of Gyanarthi Media College is widespread in the beautiful city of Kashipur.</p>
                        </div>
                        ...
                        <div >
                            ...
                            <p className='urbanpara'>The teachers at Gyanarthi belong to diverse academic backgrounds. Their experience and expertise ensures quality education. </p>
                        </div>
                        <div >
                            <div className="mb-4">
                            ...
                            <p className='urbanpara'>Bachelor of Commerce at Gyanarthi has professional streams such as Taxation, International Business, and more. </p>
                        </div>
                        <div >
                            <div className="mb-4">
                            ...
                            <p className='urbanpara'>Gyanarthi collaborates with Industry Experts to provide the students with constant insights to boost their career. </p>
                        </div>
                    </div>
                </div>
            </section>
