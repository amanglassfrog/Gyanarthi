                                ...
                                <div className=" p-6 flex flex-col items-center space-y-4">
                                    ...
                                    <div className='flex w-full justify-between'>
                                        <div><h3 className="coursename">School of Commerce</h3>
                                            <p className="text-gray-500 coursepara">{viewersCount}+ Students Viewing this course</p></div>
                                        <div><button className="bg-blue-500 text-white px-4 py-2 rounded-full focus:outline-none coursebutton"><a href="/coursepage?course=Commerce&program=BCom">
                                ...
                                <div className=" p-6 flex flex-col items-center space-y-4">
                                    ...
                                    <div className='flex w-full justify-between'>
                                        <div><h3 className="coursename">School of Design</h3>
                                            <p className="text-gray-500 coursepara">{viewersCount1}+ Students Viewing this course</p></div>
                                        <div><button className="bg-blue-500 text-white px-4 py-2 rounded-full focus:outline-none coursebutton"><a href="/coursepage?course=Design&program=BA%20Journalism%20and%20Mass%20Communication">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                            </svg></a>
                                        </button></div>
                                ...
                                <div className=" p-6 flex flex-col items-center space-y-4">
                                    ...
                                    <div className='flex w-full justify-between'>
                                        <div><h3 className="coursename">School of Media Studies</h3>
                                            <p className="text-gray-500 coursepara">{viewersCount2}+ Students Viewing this course</p></div>
                                ...
                                <div className=" p-6 flex flex-col items-center space-y-4">
                                    ...
                                    <div className='flex w-full justify-between'>
                                        <div><h3 className="coursename">School of Fine Arts</h3>
                                            <p className="text-gray-500 coursepara">{viewersCount3}+ Students Viewing this course</p></div>
                                        <div><button className="bg-blue-500 text-white px-4 py-2 rounded-full focus:outline-none coursebutton"><a href="/coursepage?course=Communication,%20and%20Arts&program=BA%20Journalism%20and%20Mass%20Communication">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                            </svg></a>
                                        </button></div>
