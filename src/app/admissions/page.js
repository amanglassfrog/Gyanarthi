          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-6">
              <div className="flex items-center gap-3">
                <h3 className="UGcourse ">B.Com (4 years)</h3>
              ...
              <div className="flex items-center gap-3">
                <h3 className="UGcourse ">B.Com Banking and Finance<br></br> (4 years)</h3>
              ...
              <div className="flex items-center gap-3">
                <h3 className="UGcourse "> B.Com Financial Accounting <br></br>(4 years)</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-6">
              ...
              <div className="flex items-center gap-3">
                <h3 className="UGcourse "> B.Sc Fashion Designingn<br></br> (4 years)</h3>
              ...
              <div className="flex items-center gap-3">
                <h3 className="UGcourse ">BA Animation and Design<br></br> (4 years)</h3>
              ...
              <div className="w-full md:w-1/3 applycard hover:bg-yellow-500 transition duration-300 ease-in-out  mb-4 md:mb-0">
                <div className="p-8">
                  ...
                  <p className="text-center mb-6 text-white journeypara">
                    Complete the Application Form for enrollment in the 2026
