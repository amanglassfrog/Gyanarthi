        ...
        <div className='flex justify-center'>
          <div className="flex flex-wrap py-8 container">
            <div className="w-full md:w-1/2 p-4">
              <h1 className="text-xl font-bold chancelorheading">Bachelor Degree in Journalism and Mass Communication</h1>
            ...
            <Tabs className="ctabs">
              ...
              <div className='flex flex-col'>
                ...
                <TabPanel className="tabpanel futurevision">
                  <div className="flex flex-wrap">
                    <div className="w-full md:w-1/2 p-4">
                      <p className='selectedcourse'>The students at Gyanarthi  College are well-equipped to move forward and prepare themselves for the fields of mass communication and media studies. The curriculum at the Gyanarthi  College is extensive and well-crafted for building careers in the right direction. Our students are thoroughly taught to navigate through the challenges in the Media and Communication world. At Gyanarthi, the faculty focuses on helping the students with domains such as Television Broadcasting and Radio Broadcasting. We make sure that our students are equipped with the appropriate knowledge in the domains of Print Journalism and even the basics of Photography. This helps the students gain ample acumen to practically test their knowledge in the domains of Journalism and Mass Communication. Gyanarthi  College is a competent institute for mass communication that equips students with the right amount of knowledge to work in the fields of Advertising and Public Relations. We ensure that our students are up to date in subjects such as Social Sciences, Indian Polity and Society, Media Research, Media Law and Ethics, Functional Hindi, and Functional English as this shall assist them in going forward with activities in Media Planning, Management, and execution very smoothly. </p>
                      <div className="pt-5">
                        <button className="text-white px-4 py-2 vp focus:outline-none"><a href='/contact'>Apply Now</a></button>
                      </div>
                    </div>
...
The prime objective of the faculty at the Gyanarthi  College, Kashipur is to enhance the professional profiles of the students. We seek to create professionals who are equipped with thorough knowledge in the relative domains of Mass Communication and Media Studies. The courses at the Gyanarthi  College are affiliated with Kumaun University and the curriculum is curated with a vision to make it one of the prime options for the best course after Class 12th in the field of Journalism and Mass Communication. The students can check all the details of the bachelor degree in journalism and mass communication to get a comprehension of what it has to offer to the students.</p>
              <Tabs className="cctabs pt-16">
                ...
                <div>
                  ...
                  <TabPanel className="tabpanel">
                    <p className='kalakari'>The curriculum of Journalism and Mass Communication Courses at the Gyanarthi  College is very balanced. It is intricately designed to keep up with the latest market requirements, and Public Relations is one of them. The students are prepared well to navigate through Corporate Communication and Public Relations roles while they study MA Journalism and Mass Communication. </p>
                  </TabPanel>
                </div>
              </Tabs>
            </div>
