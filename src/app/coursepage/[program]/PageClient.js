...
const PageClient = ({ selectedCourse }) => {
  if (!selectedCourse) {
      ...
      <main>
        ...
        <div className='flex justify-center'>
          <div className="flex flex-wrap py-8 container">
            ...
            <div className="w-full md:w-1/2 p-4">
              <Image src={selectedCourse.image} alt="Image Description" className="max-w-full h-auto" />
            ...
            <div className="flex flex-col md:flex-row items-stretch justify-between gap-8">
              ...
              <div className="w-full md:w-1/3 applycard hover:bg-yellow-500 transition duration-300 ease-in-out mb-4 md:mb-0">
                <div className="p-8">
                  ...
                  <button className="bg-transparent hover:bg-white text-white hover:text-blue-900 font-semibold py-2 px-4 border border-white hover:border-transparent rounded-full mx-auto block"><a href='https://glassfrogtech.com/broucher.pdf' download target="_blank" className='flex items-center gap-3'>Download Now<Image src={download} alt="Image Description" className="add" /></a></button>
                </div>
              </div>
            </div>
          </div>
