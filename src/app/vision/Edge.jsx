        ...
        <div className='py-8 p-6 md:p-12 sm:px-24'>
            ...
            <Tabs className="vtabs">
                ...
                <div>
                    ...
                    <TabPanel className="tabpanel">
                        <p className='kalakari'>At Gyanarthi Media College, we invite you to bring your animation and design dreams to life through our comprehensive programs. Beginning with our Bachelor of Arts program, students acquire foundational skills essential for success in the dynamic world of animation and design. From mastering fundamental principles to exploring various techniques, students receive a solid grounding in the artistic and technical aspects of the field. Building upon this strong foundation, our Masters in Animation and Design program offers advanced training and specialization opportunities. Through intensive coursework, hands-on projects, and mentorship from industry professionals, students refine their expertise and develop a deep understanding of visual storytelling.
                    ...
                    <TabPanel className="tabpanel">
                        <p className='kalakari'>Gyanarthi Media College empowers aspiring communicators to craft their voices and shape compelling narratives through our Journalism & Mass Communication programs. Our Bachelor's degree offers a comprehensive exploration of storytelling techniques across various platforms, including print, digital, and broadcast media. Students gain practical experience through hands-on projects, internships, and industry partnerships, allowing them to develop versatile skills that are essential for success in today's media landscape. Building upon this foundation, our Master's program delves deeper into advanced topics, equipping students with the expertise and insights needed to become media powerhouses. From investigative reporting to multimedia storytelling, students have the opportunity to refine their craft under the guidance of experienced faculty and industry professionals.
