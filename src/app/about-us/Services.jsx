      ...
      <div className="max-w-6xl mx-auto container">
        <div className=" p-2 md:p-4 sm:py-8 ">
          <p className="text-lg chancelorparagraph">
            ...
            experience. Students at Gyanarthi are constantly provided with
            insights from Industry Experts through the means of Workshops and
            Industrial Visits. Additionally, the teachers at Gyanarthi are keen
            on letting the students take ownership of their activities and
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="whygyanoptionspara">
              The college is built widely in the city of Kashipur and is
              equipped with all the facilities to compose a state-of-the-art
              infrastructure that expands beyond the realms of basic education.{" "}
            </p>
          </div>
          <div>
            <div className="mb-4 flex ">
          ...
          <div>
            ...
            <p className="whygyanoptionspara">
              Students at Gyanarthi are offered the most insightful educative
              experience. The college provides constant workshops by Industrial
              Experts and Visits to real-time work spaces for competent study.{" "}
            </p>
          </div>
        </div>
      </div>
