                        ...
                        <div className="flex flex-wrap -mx-4">
                            <div className="w-full md:w-1/2 px-4 mb-8">
                                <div className="bg-yellow-200 p-8 rounded-lg proradius">
                                    <h3 className="text-xl font-semibold mb-4 text-center protext">Industry Specific Courses for Advanced Learning</h3>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2 px-4 mb-8">
                                <div className="bg-green-200 p-8 rounded-lg proradius2">
                                    <h3 className="text-xl font-semibold mb-4 text-center protext">Expert Faculty keen on turning Education into Experience</h3>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2 px-4 mb-8">
                                <div className="bg-red-200 p-8 rounded-lg proradius">
                                    <h3 className="text-xl font-semibold mb-4 text-center protext">Workshops and Visits for Practical Understanding</h3>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2 px-4 mb-8">
                                <div className="bg-blue-200 p-8 rounded-lg proradius2">
                                    <h3 className="text-xl font-semibold mb-4 text-center protext">Events where Creativity of Students Flows</h3>
                                </div>
                            </div>
                        </div>
                    </div>
